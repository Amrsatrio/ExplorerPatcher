...
void sws_error_PrintStackTrace2();
    ...
    switch (featureId)
    {
...
#endif
#if 1
        case 38664959: // FERecommendations
        case 40729001: // WASDKInFileExplorer
        {
            if (dwFileExplorerCommandUI != 0)
            {
                ...
                //
                // With FERecommendations, we also restore the Quick Access section in the non-WASDK Home page since
                // that also exists in the WASDK Home page despite FERecommendations being enabled.
                //
